...
public abstract class Dn_CamWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static Dn_CamWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(Dn_CamWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<Dn_CamDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<Dn_CamDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<Dn_CamDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<Dn_CamDbContext, Task<T>> func)
    {
        T result;
