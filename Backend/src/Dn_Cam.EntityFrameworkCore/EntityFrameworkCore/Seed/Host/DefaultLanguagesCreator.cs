...
namespace Dn_Cam.EntityFrameworkCore.Seed.Host;
...
public class DefaultLanguagesCreator
{
    ...
    {
        var tenantId = Dn_CamConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
    ...
    public DefaultLanguagesCreator(Dn_CamDbContext context)
    {
        _context = context;
    }
